...
from vae.vae_conv_I_model import VariationalAutoencoderConvInterpretable as VAE_Int
...
def train_vae(vae, train_data, max_epochs, verbose=0):
    ...
    history = vae.fit(train_data, epochs=max_epochs, verbose=verbose)
...
def load_vae_model(vae_type: str, dir_path: str) -> Union[VAE_Int]:
    """
